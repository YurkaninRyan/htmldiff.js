...
(function() {
  var Match, calculate_operations, consecutive_where, create_index, diff, diff_dual_pane, ends_in_end_script_tag, find_match, find_matching_blocks, get_key_for_token, html_to_tokens, is_end_of_atomic_tag, is_end_of_tag, is_script_tag, is_start_of_atomic_tag, is_start_of_tag, is_tag, is_void_tag, is_whitespace, is_wrappable, isnt_tag, op_map, recursively_find_matching_blocks, render_operations, render_operations_dual_pane, return_dual_pane, wrap;
  ...
  html_to_tokens = function(html) {
    var atomic_tag, char, current_atomic_tag, current_word, i, len, mode, words;
    mode = 'char';
    current_word = '';
    current_atomic_tag = '';
    words = [];
  ...
  create_index = function(options) {
    var i, idx, index, len, queries, query, results;
  ...
  render_operations_dual_pane = function(before_tokens, after_tokens, operations, class_name) {
  ...
  diff_dual_pane = function(before, after, class_name) {
    var ops;
    if (before === after) {
    ...
    return render_operations_dual_pane(before, after, ops, class_name);
  };
